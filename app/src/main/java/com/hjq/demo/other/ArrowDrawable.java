...
public final class ArrowDrawable extends Drawable {
    ...
    public static final class Builder {
         ...
         * 应用到 View
         */
        public void apply(View view, boolean isBottom) {
            view.setBackground(build());
            if (mShadowSize > 0 || mArrowHeight > 0) {
                if (view.getPaddingTop() == 0 && view.getBottom() == 0 && view.getPaddingLeft() == 0 && view.getPaddingRight() == 0) {
                    int originArrowSize = mShadowSize;
                    int withArrowHeight = originArrowSize + mArrowHeight;
                    view.setPadding(originArrowSize, isBottom ? originArrowSize : withArrowHeight,
                            originArrowSize, isBottom ? withArrowHeight : originArrowSize);
                }
            }
        }
    }
