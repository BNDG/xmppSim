...
public final class ListPopup {
    ...
    public static final class Builder
        ...
        public Builder(Context context, int gravity) {
            ...
            recyclerView.setBackgroundResource(R.drawable.popup_fixed_alert);
          /*  new ArrowDrawable.Builder(context)
                    .setArrowOrientation(gravity)
                    .setArrowGravity(Gravity.CENTER)
                    .setShadowSize((int) getResources().getDimension(R.dimen.dp_10))
                    .setBackgroundColor(0xFFFFFFFF)
                    .apply(recyclerView, gravity == Gravity.TOP);*/
        }
        ...
        public Builder setPopupYOffset(int height) {
            Trace.d("setPopupYOffset: " + mAdapter.getCount());
            setYOffset(height - mAdapter.getCount() * SizeUtils.dp2px(20) - SizeUtils.dp2px(50));
            return this;
        }
    }
        ...
        private final class ViewHolder extends AppAdapter<?>.ViewHolder {
            ...
            ViewHolder() {
                ...
                mTextView.setLayoutParams(new LinearLayout.LayoutParams(
                        ...
                        LinearLayout.LayoutParams.WRAP_CONTENT)); // 高度可以根据需要设置
            }
