 ...
 *    desc   : 登录界面
 */
public final class DemoLoginActivity extends AppActivity
    ...
    protected void initData() {
        postDelayed(() -> {
            KeyboardWatcher.with(DemoLoginActivity.this)
                    .setListener(DemoLoginActivity.this);
        }, 500);
    ...
    public void onRightClick(View view) {
        // 跳转到注册界面
        DemoRegisterActivity.start(this, mPhoneView.getText().toString(),
                    ...
                    .request(new HttpCallbackProxy<HttpData<LoginApi.Bean>>(this) {
                        ...
                        public void onHttpSuccess(HttpData<LoginApi.Bean> data) {
                            ...
                            EasyConfig.getInstance()
                                    .addParam("token", data.getData().tpassword);
                            postDelayed(() -> {
                                mCommitView.showSucceed();
                                postDelayed(() -> {
                                    // 跳转到首页
