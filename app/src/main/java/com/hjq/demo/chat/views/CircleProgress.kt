...
class CircleProgress @JvmOverloads constructor(
    ...
    init {
        ...
        mSize = a.getDimensionPixelSize(R.styleable.CircleProgress_size, SizeUtils.px2dp(40f))
        mBorderWidth = a.getDimensionPixelSize(
            R.styleable.CircleProgress_progressWidth,
//            context.dip(DEFAULT_BORDER_WIDTH)
            SizeUtils.px2dp(DEFAULT_BORDER_WIDTH.toFloat())
        )
        ...
        mPlayColor = a.getColor(
            ...
            context.getColor(R.color.primary_chat_user)
        )
