...
public final class UmengClient {
    ...
    public static void init(Application application, String channel) {
        ...
        UMConfigure.init(application, BuildConfig.UM_KEY, channel, UMConfigure.DEVICE_TYPE_PHONE, "");
        // 获取设备的 oaid
     ...
     */
    public static void preInit(Application application, boolean logEnable, String channel) {
        UMConfigure.preInit(application, BuildConfig.UM_KEY, channel);
