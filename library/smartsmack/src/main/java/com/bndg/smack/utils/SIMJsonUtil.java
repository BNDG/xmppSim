...
//	List<Person> ps = gson.fromJson(str, new TypeToken<List<Person>>(){}.getType());
    ...
    public static boolean isFileType(String msgType) {
        return SmartContentType.IMAGE.equals(msgType) || SmartContentType.FILE.equals(msgType) || SmartContentType.VOICE.equals(msgType)
                || SmartContentType.VIDEO.equals(msgType);
    }
}