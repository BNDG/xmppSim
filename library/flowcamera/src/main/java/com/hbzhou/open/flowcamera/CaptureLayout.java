    ...
    private void switchTextTip(int state) {
        switch (state) {
            case BUTTON_STATE_BOTH:
                textTip = getContext().getString(R.string.click_long_press);
                txt_tip.setText(textTip);
                break;
            case BUTTON_STATE_ONLY_CAPTURE:
                textTip = getContext().getString(R.string.click_take_photo);
                txt_tip.setText(textTip);
                break;
            case BUTTON_STATE_ONLY_RECORDER:
                textTip = getContext().getString(R.string.long_press_record);
                txt_tip.setText(textTip);
                break;
        }
    }
