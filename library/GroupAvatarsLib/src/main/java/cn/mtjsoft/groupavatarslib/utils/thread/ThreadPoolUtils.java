...
public class ThreadPoolUtils {
    ...
    static {
        ...
        DEFAULT_EXECUTOR =
                new ThreadPoolExecutor(corePoolSize, corePoolSize * 2, 30, TimeUnit.SECONDS, new ArrayBlockingQueue<>(1024, true),
                        new NamingThreadFactory("ThreadPoolUtils"));
     ...
     * @param unit         执行周期时间单位
     */
    public static ScheduledFuture<?> scheduleAtFixedRateInDaemon(Runnable runnable, long initialDelay, long period,
                                                                 TimeUnit unit) {
